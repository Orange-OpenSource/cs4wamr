...
#define SNAPSHOT1                                                                                                      \
    wamr_env_thread_pause(ENV_0);                                                                                      \
    wamr_env_thread_save(ENV_0, &saved_env_thread, saving_buffer, sizeof(saving_buffer));                              \
    wamr_env_thread_resume(ENV_0);
#define SNAPSHOT2                                                                                                      \
    wamr_env_thread_pause(ENV_2);                                                                                      \
    wamr_env_thread_save(ENV_2, &saved_env_thread, saving_buffer, sizeof(saving_buffer));                              \
    wamr_env_thread_resume(ENV_2);
#define RESTORE1 wamr_env_thread_restored(ENV_0, &saved_env_thread, saving_buffer, sizeof(saving_buffer));
    BENCHMARK_FUNC("SNAPSHOT1", 1, SNAPSHOT1);
    BENCHMARK_FUNC("SNAPSHOT2", 1, SNAPSHOT2);
    BENCHMARK_FUNC("SNAPSHOT1", 1, SNAPSHOT1);
    BENCHMARK_FUNC("RESTORE1", 1, RESTORE1);
    BENCHMARK_FUNC("SNAPSHOT1", 1, SNAPSHOT1);
    BENCHMARK_FUNC("SNAPSHOT2", 1, SNAPSHOT2);
    BENCHMARK_FUNC("SNAPSHOT1", 1, SNAPSHOT1);
    BENCHMARK_FUNC("RESTORE1", 1, RESTORE1);

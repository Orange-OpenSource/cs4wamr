...
#  message( FATAL_ERROR "info ${CPU} - ${WAMR_BUILD_TARGET} - ${CMAKE_SYSTEM_PROCESSOR} - $ENV{CPU}"  )
#if("${WAMR_BUILD_TARGET}" STREQUAL "THUMB_VFP")
if("$ENV{CPU}" STREQUAL "nrf52")
set (WAMR_BUILD_TARGET THUMBv7em_VFP)
endif()

if("$ENV{CPU}" STREQUAL "nrf9160")
set (WAMR_BUILD_TARGET THUMBV8M_VFP)
endif()

#set (WASM_DISABLE_STACK_HW_BOUND_CHECK 1)
